...
* **Changed:** The upgrade notification now only shows on applicable admin pages, instead of on all the admin pages.
	* The main dashboard, core updates, plugin overview, and the SEO settings pages are the applicable pages.

= 1.5.3 =

**Plugin Improvements:**

* **Fixed:** Markdown links now render correctly with the number `1`.
* **Note:** We're migrating this plugin. Please see [our blog post](https://theseoframework.com/?p=2747) for more information.
...
* **Improved:** The new flat buttons' text is now aligned optically vertical.
* **Fixed:** The SEO Extensions administrative page now handles multiple-instance browsing API dispatching correctly, preventing error messages that aren't useful.
* **Fixed:** Via-AJAX invoked notices no longer pile up, nor will they bounce the screen anymore.
